...
def get_cub(data_path, split="train", preprocessing=True, transform=None):
    import timm
    from circuit_src.datasets.cub2011 import Cub2011
    
    # HARD coding for resnet50_cub
    ...
    test_dataset = Cub2011(data_path, train=False, download=False, transform=transform)
    return test_dataset


def get_imagenet(data_path, split="val", preprocessing=True, transform=None):
    ...
    if not preprocessing:
        ...
        transform = transforms.Compose(transform)
    return ImageNetDataset(data_path, train=split == "train", transform=transform, norm_stat=norm_stat)


def get_food(data_path, split="val", preprocessing=True, transform=None):
    if transform is None:
        if split == "train":
    ...
    # Extract normalization stats to pass into the dataset object
    norm_stat = None
    ...
    # else: transform is already composed
...
class ImageNetDataset(datasets.ImageFolder):
    def __init__(self, root, *args, validate=False, train=True, use_precomputed_labels=False,
                 labels_path=None, transform=None, norm_stat=None, **kwargs):
