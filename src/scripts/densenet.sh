...
MODEL_NAME="densenet_timm"

LAYER_LIST=("features.denseblock2.denselayer1" "features.denseblock3.denselayer12" "features.denseblock4.denselayer16")
PREV_LAYER_LIST=("features.denseblock1.denselayer6" "features.denseblock3.denselayer11" "features.denseblock4.denselayer15")

# echo "Step 0: Extracting raw activations for all layers..."
# python /project/src/experiments/preprocessing/extract_activations.py \
#     --layers_to_hook features.denseblock2.denselayer1 output features.denseblock3.denselayer12 output features.denseblock4.denselayer16 output \
#     --batch_size 256 \
#     --pool_type raw \
