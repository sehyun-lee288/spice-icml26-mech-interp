...
MODEL_NAME="vit_s_16_timm"

# echo "Step 0: Extracting raw activations for all layers..."
# python /project/src/experiments/preprocessing/extract_activations.py \
#     --layers_to_hook blocks.11 output blocks.10 output blocks.9 output blocks.8 output blocks.7 output blocks.6 output blocks.5 output blocks.4 output blocks.3 output blocks.2 output blocks.1 output blocks.0 output \
#     --batch_size 256 \
#     --pool_type raw \
