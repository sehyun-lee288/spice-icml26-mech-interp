...
python /project/src/experiments/preprocessing/extract_activations.py \
    --layers_to_hook blocks.4 output \
    --batch_size 256 \
    --pool_type raw \
...
process_layer() {
    ...
    #     --top_percentile 10.0 \
    #     --output_dir "/project/results/top_activations/imagenet/$MODEL_NAME/top10pct_middle" \
    #     --mode middle \
    #     --save_values
    ...
    #     --all_neurons \
    #     --top_index_file "/project/results/top_activations/imagenet/$MODEL_NAME/top10pct_middle/top_activations_${SAFE_LAYER}_output_indices.npy" \
    #     --output_dir "/project/results/attributions/imagenet/top10pct_middle"
